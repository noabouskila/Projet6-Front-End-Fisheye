class TemplateCard{
    ...
    getUserCardDOM() {
        ...
        <article>
            <img class="portrait" src="./assets/photographers/portraitPhotographers/${this._photo.portrait}" 
            alt="aller sur la page de :  ${this.photo.name} ,  
            ${this.photo.city} , ${this.photo.tagline} , ${this.photo.price}€ par jour">
